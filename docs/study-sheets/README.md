...
- **Phase 0:** Demo laden → die **10 Aufgaben sind fertig**, **nicht** von Hand nachbauen.
...
Die Texte **nennen keine Bedingung** (z. B. Baseline vs. anderes) und **verraten nicht**, welche Hilfen erscheinen — damit der **Vergleich fair** bleibt und Nutzer **selbst** einschätzen, was ihnen hilft.
